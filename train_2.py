...
def train_2(model_name,name_prefix="", optimizer=None, start_epoch=0, criterionType="ce", weighted=False, ignore=False, num_epochs=5, batch_size=64, learning_rate=1e-3, weight_decay=1e-5):
    ...
    log = open("./model/" + name_prefix + model_name + ".log", "w+")
